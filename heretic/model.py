...
class Model:
    def __init__(self, settings: Settings):
        ...
        # Heretic always uses causal LM generation, which expects left padding
        # for correct batched decoding.
    ...
    def format_chat(
        ...
        *,
        ...
        try:
            ...
            if not self._missing_chat_template(error):
                raise
            return self._fallback_chat_prompt(
                chat,
                add_generation_prompt=add_generation_prompt,
            )
    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        chat_prompts: list[str] = self.format_chats(
            chats,
