...
class Settings(BaseSettings):
    ...
    good_prompts: DatasetSpecification = Field(
        default=DatasetSpecification(
            dataset="dataset/splits/harmless_train.json",
            split="[:400]",
            column="instruction",
        ),
    ...
    bad_prompts: DatasetSpecification = Field(
        default=DatasetSpecification(
            dataset="dataset/splits/harmful_train.json",
            split="[:400]",
            column="instruction",
        ),
    ...
    good_evaluation_prompts: DatasetSpecification = Field(
        default=DatasetSpecification(
            dataset="dataset/splits/harmless_test.json",
            split="[:100]",
            column="instruction",
        ),
    ...
    bad_evaluation_prompts: DatasetSpecification = Field(
        default=DatasetSpecification(
            dataset="dataset/splits/harmful_test.json",
            split="[:100]",
            column="instruction",
        ),
